<?php
    ...
    $tintuc_list = $d->rawQuery("select ten$lang, tenkhongdau$lang, id, photo from #_news_list where type = ? and hienthi > 0 order by stt, id desc ",array('tin-tuc'));
    $duan_foodter = $d->rawQuery("select ten$lang, tenkhongdau$lang, id from #_product where type = ? and hienthi > 0 order by stt,id desc limit 0,3",array('du-an'));
