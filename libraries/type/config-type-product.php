<?php
    ...
    $config['product'][$nametype]['status'] = true;
    ...
    $config['product'][$nametype]['area'] = true;
    ...
    (
        ...
        "tien-ich" => array
        (
            "title_main_photo" => "Tiện ích",
            "title_sub_photo" => "Tiện ích",
            "number_photo" => 1,
            "images_photo" => true,
            "noidung" => true,
            "avatar_photo" => true,
            ...
            "width_photo" => 1160,
            "height_photo" => 580,
            "thumb_photo" => '879x440x2',
            "tieude_photo" => true,
            "img_type_photo" => '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF'
        ),
        "vi-tri" => array
        (
            "title_main_photo" => "Vị trí",
            "title_sub_photo" => "Vị trí",
            "number_photo" => 1,
            "images_photo" => true,
            "noidung" => true,
            "avatar_photo" => true,
    ...
    $config['product'][$nametype]['thumb'] = '1519x506x1';
