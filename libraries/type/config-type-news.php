<?php
    ...
    $config['news'][$nametype]['width_list'] = 1920;
    $config['news'][$nametype]['height_list'] = 600;
    $config['news'][$nametype]['thumb_list'] = '1920x600x1';
    ...
    $config['news'][$nametype]['noidung_cke'] = true;
    $config['news'][$nametype]['seo'] = true;
    $config['news'][$nametype]['width'] = 840;
    $config['news'][$nametype]['height'] = 560;
    ...
    $config['news'][$nametype]['width'] = 1054;
    ...
    $config['news'][$nametype]['height'] = 960;
