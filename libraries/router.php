...
$requick = array(
	/* Sản phẩm */
	array("tbl" => "product_list", "field" => "idl", "source" => "product", "com" => "san-pham", "type" => "du-an", 'menu' => true),
	...
	array("tbl" => "news", "field" => "id", "source" => "news", "com" => "gia-tri-cot-loi", "type" => "gia-tri-cot-loi", 'menu' => true),
